...
@pytest.mark.django_db
def _test_list_course(client, course_factory):
    # Arrange
    curs = course_factory(_quantity= 10)
...
@pytest.mark.django_db
def _test_list_course_filter_id(client, course_factory):
    # Arrange
    curs = course_factory(_quantity= 10)
...
@pytest.mark.django_db
def _test_list_course_filter_name(client, course_factory):
    # Arrange
...
@pytest.mark.django_db
def _test_create_course(client):
    # Arrange
...
@pytest.mark.django_db
def _test_update_course(client, course_factory):
    # Arrange
    curs = course_factory(_quantity= 5)
    #  Act
    response = client.patch('/api/v1/courses/2/', data={'name': 'match'})
...
@pytest.mark.django_db
def _test_dalete_course(client, course_factory):
    # Arrange
